                                            ...
                                            <div class="col-12">
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label for="address-first-name">Obyekt turi</label>
                                                        <div class="form-group d-flex">
                                                            @foreach(\DB::table('object_types')->get() as $obt)
                                                                <label class="payment-methods__item-header btn-secondary mr-2" for="object_type_{{ $obt->id }}"><span
                                                                        class="payment-methods__item-radio input-radio"><span
                                                                            class="input-radio__body"><input
                                                                                class="input-radio__input"
                                                                                name="type_id"
                                                                                id="object_type_{{ $obt->id }}"
                                                                                value="{{ $obt->id }}"
                                                                                type="radio"> <span
                                                        ...
                                                        <div class="form-group d-flex flex-wrap appointments">
                                                            @foreach(\DB::table('object_category')->get() as $cat)
                                                                <label class="payment-methods__item-header btn-secondary mt-2 mr-2 object_category object_type_{{$cat->id_object_type}}"
                                                                       for="object_cat_{{ $cat->id }}" style="display:none">
                                                ...
                                                <div class="form-group"><label>Taklif turi</label>
                                                ...
                                                <div class="form-group">
                                                    <div id="rent_price" style="display:none">
                                                        <div>Ijara narxi</div>
                                                        <div class="d-flex justify-between row">
                                                            ...
                                                            <input type="text" class="form-control ml-3 only_digit col-md-7" id="address" value="" name="price[rent]" placeholder="Цена" autocomplete="off">
                                                        </div>
                                                    </div>
