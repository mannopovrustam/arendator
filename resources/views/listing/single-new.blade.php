<div class="product product--layout--sidebar">
	...
	c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z"></path>
                ...
                -->
                    <div class="owl-stage-outer">
                        <div class="owl-stage"
                             style="transform: translate3d(0px, 0px, 0px); transition: all; width: 1720px;">

                            @foreach(explode(',', $listing->images) as $img)
                                <div class="owl-item @if($loop->first) active @endif" style="width: 430px;"><a class="image image--type--product"
                                                                                      href="{{ $img }}"
                                                                                      target="_blank" data-width="700"
                                                                                      data-height="700">
            ...
            <div class="product-gallery__thumbnails">
                <div class="owl-carousel owl-loaded owl-drag">
                    <div class="owl-stage-outer">
                        <div class="owl-stage"
                             style="transform: translate3d(0px, 0px, 0px); transition: all; width: 294px;">
                            <div class="owl-item active" style="width: 63.333px; margin-right: 10px;">
                                <div
                                    class="product-gallery__thumbnails-item image image--type--product product-gallery__thumbnails-item--active">
                                    <div class="image__body"><img class="image__tag"
                                                                  src="images/products/product-2-70x70.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="owl-item active" style="width: 63.333px; margin-right: 10px;">
                                <div class="product-gallery__thumbnails-item image image--type--product">
                                    <div class="image__body"><img class="image__tag"
                                                                  src="images/products/product-1-70x70.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="owl-item active" style="width: 63.333px; margin-right: 10px;">
                                <div class="product-gallery__thumbnails-item image image--type--product">
                                    <div class="image__body"><img class="image__tag"
                                                                  src="images/products/product-3-70x70.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="owl-item active" style="width: 63.333px; margin-right: 10px;">
                                <div class="product-gallery__thumbnails-item image image--type--product">
                                    <div class="image__body"><img class="image__tag"
                                                                  src="images/products/product-4-70x70.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="product__header"><h1 class="product__title">Brandix Brake Kit BDX-750Z370-S</h1>
                            ...
                            <div class="product-form__control">
                                <div class="input-radio-label">
                                    <div class="input-radio-label__list"><label class="input-radio-label__item"><input
                                            ...
                                            <span class="input-radio-label__title">Aluminium</span></label> <label
                                            class="input-radio-label__item"><input type="radio" name="material"
                                                                                   class="input-radio-label__input"
                            ...
                            <div class="product-form__control">
                                <div class="input-radio-color">
                                    <div class="input-radio-color__list"><label
                                            ...
                                            style="color: #fff;" data-toggle="tooltip" title=""
                                            data-original-title="White"><input type="radio" name="color"> <span></span></label>
                                        <label class="input-radio-color__item" style="color: #ffd333;"
                                               data-toggle="tooltip" title="" data-original-title="Yellow"><input
                                                type="radio" name="color"> <span></span></label> <label
                                            class="input-radio-color__item" style="color: #ff4040;"
                                            data-toggle="tooltip" title="" data-original-title="Red"><input type="radio"
                                                                                                            name="color">
                                            <span></span></label> <label
                                            class="input-radio-color__item input-radio-color__item--disabled"
                                            style="color: #4080ff;" data-toggle="tooltip" title=""
                                            data-original-title="Blue"><input type="radio" name="color"
	...
	s3.3,1.5,3.3,3.3S15.4,42.9,13.6,42.9z M40,42.9c-1.8,0-3.3-1.5-3.3-3.3s1.5-3.3,3.3-3.3s3.3,1.5,3.3,3.3S41.8,42.9,40,42.9z
	 M45.6,33.3c-0.5,0-0.9-0.4-0.9-0.9v-0.9h1.7v1.7L45.6,33.3L45.6,33.3z"></path>
                                <path
                                    d="M13.6,38.1c-0.9,0-1.6,0.7-1.6,1.6s0.7,1.6,1.6,1.6s1.6-0.7,1.6-1.6S14.4,38.1,13.6,38.1z"></path>
                                <path
                                    d="M40,38.1c-0.9,0-1.6,0.7-1.6,1.6s0.7,1.6,1.6,1.6c0.9,0,1.6-0.7,1.6-1.6S40.9,38.1,40,38.1z"></path>
                                <path
                                    d="M19.2,35.6c0,0.4,0.3,0.8,0.8,0.8h11.2c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8H20C19.6,34.9,19.2,35.2,19.2,35.6z"></path>
                                <path
                                    d="M2.4,33.2H12c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8H2.4c-0.4,0-0.8,0.3-0.8,0.8S1.9,33.2,2.4,33.2z"></path>
	...
	c-0.3-0.5-0.5-1.1-0.5-1.6c0-1.7,1.4-3.1,3.1-3.1C36.4,11.9,37.8,13.3,37.8,15z"></path>
                                <path
                                    d="M6,24.1c-0.4,0-0.8,0.4-0.8,0.8c0,0.4,0.4,0.8,0.8,0.8h6.9c0.4,0,0.8-0.4,0.8-0.8c0-0.4-0.4-0.8-0.8-0.8H6z"></path>
                                <path
                                    d="M30.9,29.2H6c-0.4,0-0.8,0.4-0.8,0.8c0,0.4,0.4,0.8,0.8,0.8h24.9c0.4,0,0.8-0.4,0.8-0.8S31.3,29.2,30.9,29.2z"></path>
                                <path
                                    d="M16.3,24.1c-0.4,0-0.8,0.4-0.8,0.8c0,0.4,0.4,0.8,0.8,0.8h6.9c0.4,0,0.8-0.4,0.8-0.8c0-0.4-0.4-0.8-0.8-0.8H16.3z"></path>
                                <path
                                    d="M31.7,24.1h-5.2c-0.4,0-0.8,0.4-0.8,0.8c0,0.4,0.4,0.8,0.8,0.8h5.2c0.4,0,0.8-0.4,0.8-0.8C32.5,24.4,32.2,24.1,31.7,24.1z"></path>
        ...
        <div class="product__tabs product-tabs product-tabs--layout--sidebar">
            ...
            <div class="product-tabs__content">
                <div class="product-tabs__pane product-tabs__pane--active" id="product-tab-description">
                    <div class="typography"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
                            fermentum, diam non iaculis finibus, ipsum arcu sollicitudin dolor, ut cursus sapien sem sed
                            purus. Donec vitae fringilla tortor, sed fermentum nunc. Suspendisse sodales turpis dolor,
                            at rutrum dolor tristique id. Quisque pellentesque ullamcorper felis, eget gravida mi
                            elementum a. Maecenas consectetur volutpat ante, sit amet molestie urna luctus in. Nulla
                            eget dolor semper urna malesuada dictum. Duis eleifend pellentesque dui et finibus.
                            Pellentesque dapibus dignissim augue. Etiam odio est, sodales ac aliquam id, iaculis eget
                            lacus. Aenean porta, ante vitae suscipit pulvinar, purus dui interdum tellus, sed dapibus mi
                            mauris vitae tellus.</p><h4>Etiam lacus lacus mollis in mattis</h4>
                            ...
                            <div class="reviews-list">
                                <ol class="reviews-list__content">
                                    <li class="reviews-list__item">
                                        <div class="review">
                                            <div class="review__body">
                                                <div class="review__avatar"><img src="images/avatars/avatar-1-42x42.jpg"
                                                                                 alt=""></div>
                                                ...
                                                <div class="review__content typography">Phasellus id mattis nulla.
                                                    Mauris velit nisi, imperdiet vitae sodales in, maximus ut lectus.
                                                    Vivamus commodo scelerisque lacus, at porttitor dui iaculis id.
                                    ...
                                    <li class="reviews-list__item">
                                        <div class="review">
                                            <div class="review__body">
                                                <div class="review__avatar"><img src="images/avatars/avatar-2-42x42.jpg"
                                                                                 alt=""></div>
                                                <div class="review__meta">
                                                ...
                                                <div class="review__content typography">Aenean non lorem nisl. Duis
                                                    tempor sollicitudin orci, eget tincidunt ex semper sit amet. Nullam
                                                    neque justo, sodales congue feugiat ac, facilisis a augue. Donec
                                                    tempor sapien et fringilla facilisis. Nam maximus consectetur diam.
                                    ...
                                    <li class="reviews-list__item">
                                        <div class="review">
                                            <div class="review__body">
                                                <div class="review__avatar"><img src="images/avatars/avatar-3-42x42.jpg"
                                                                                 alt=""></div>
                                                <div class="review__meta">
                                                ...
                                                <div class="review__content typography">Duis ac lectus scelerisque quam
                                                    blandit egestas. Pellentesque hendrerit eros laoreet suscipit
                                                    ultrices.
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="reviews-list__pagination">
                                    <ul class="pagination">
                                        <li class="page-item disabled"><a class="page-link page-link--with-arrow"
                                                    ...
                                                    class="page-link__arrow page-link__arrow--left" aria-hidden="true"><svg
                                                        width="7" height="11"><path
                                                            d="M6.7,0.3L6.7,0.3c-0.4-0.4-0.9-0.4-1.3,0L0,5.5l5.4,5.2c0.4,0.4,0.9,0.3,1.3,0l0,0c0.4-0.4,0.4-1,0-1.3l-4-3.9l4-3.9C7.1,1.2,7.1,0.6,6.7,0.3z"></path></svg></span></a>
                                        </li>
                                        ...
                                        <li class="page-item"><a class="page-link page-link--with-arrow" href=""
                                                    ...
                                                    class="page-link__arrow page-link__arrow--right" aria-hidden="true"><svg
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"></path></svg></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-12 col-xl-10 col-12">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4"><label for="review-author">Your Name</label>
